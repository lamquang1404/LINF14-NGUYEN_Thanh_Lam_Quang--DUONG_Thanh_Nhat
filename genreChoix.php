...
<head>
  ...
  <style>
    #header { background-image: url("album.jpg"); height: 400px;margin-bottom: 50px; background-size: cover;}
...
<center>
  <table class="table table-bordered">
    <tr>
      <td> A Choisir</td>
      <td><a href="genre.php?genre=Baroque">Baroque</a></td>
       <td><a href="genre.php?genre=Classique">Classique</a></td>
       <td><a href="genre.php?genre=Comtemporen">Comtemporen</a></td>
    </tr>
    <tr>
      <td><a href="genre.php?genre=Moderne">Moderne</a></td>
       <td><a href="genre.php?genre=Moyen Age">Moyen Age</a></td>
        <td><a href="genre.php?genre=Musique Ancien">Musique Ancien</a></td>
         <td><a href="genre.php?genre=Musique Sacree">Musique Sacree</a></td>
    </tr>
    <tr>
       <td><a href="genre.php?genre=Opera">Opera/a></td>
        <td><a href="genre.php?genre=Oratorio">Oratorio</a></td>
         <td><a href="genre.php?genre=Renaissance">Renaissance</a></td>
          <td><a href="genre.php?genre=Romantique">Romantique</a></td>
    </tr>
  </table>
<div id="signUP">
    <br/>
