...
<head>
  ...
  <style>
    #header { background-image: url("coord.png"); height: 400px;margin-bottom: 50px; background-size: cover;}
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div>
      ...
      <ul class="nav navbar-nav navbar-right">
            ...
            echo "<li><a href=\"#\"><span class=\"glyphicon glyphicon-user\"></span>".$_SESSION["NOM_USER"]."</a></li>
...
<div id="group">
  <center>
    <img src="quang.jpg" alt="#" width="800" height="400" >
    <p>Nguyen Thanh Lam Quang, ce qui travaille sur le PHP code</p>
    <img src="nhat.jpg" alt="#" width="400" heigth="400">
    <p>Duong Thanh Nhat, ce qui est chargé de décorer la graphique du web</p>
  </center>
</div>
<div id="signUP">
    <br/>
