    ...
    <div>
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<?php
			...
			$query = "Select Album.Titre_Album, Album.Année_Album, Album.Code_Album from Album INNER JOIN Genre ON Album.Code_Genre = Genre.Code_Genre where Genre.Libellé_Abrégé LIKE '%" . $_GET['genre'] . "%'";
			echo 
