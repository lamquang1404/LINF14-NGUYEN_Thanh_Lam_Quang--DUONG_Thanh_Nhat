...
<html>
    ...
    <div>
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<form id="f" method="get" action="lesAlbums.php">
	       <input type="text" name="album" placeholder="Recherche par titre d'album"><button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button></input> 
	    </form>
		<?php
			...
			if (isset($_GET['album']))
				$query = "Select Titre_Album,Année_Album,Code_Album from Album where Titre_Album LIKE '%" . $_GET['album'] . "%'";
			else 
				$query = "Select Titre_Album,Année_Album,Code_Album from Album";
			echo 
			"<table class=\"table table-bordered\">";
				echo"<tr><th>TITRE ALBUM</th><th>ANNEE</th><th>IMAGE</th>";
