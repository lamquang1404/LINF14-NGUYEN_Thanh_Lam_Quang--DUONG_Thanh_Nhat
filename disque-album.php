...
<head>
  ...
  <style>
    #header { background-image: url("disque1.jpg"); height: 400px;margin-bottom: 50px; background-size: cover;}
...
<?php
    ...
    $query = "select Enregistrement.Titre,Enregistrement.Code_Morceau, Enregistrement.Prix
    ...
    echo 
      "<table class=\"table table-bordered\">";
        echo"<tr><th>TITRE MORCEAU</th><th>EXTRAIT</th><th>PRIX UNITAIRE</th></tr>";
        ...
        if (empty($row['Titre']))
          ...
          if(empty($_SESSION["NOM_USER"])) {
            echo "<td><p>Vous devez se connecter pour acheter les disques!</p></td>";
          }
          else {
          echo "<td> <p>" . $row['Prix'] . " " . "Crédit </p> <br>" . "<form method=\"get\" action =\"panier.php\"> <input type=\"hidden\" name=\"Code_Morceau\" value=\" ". $row['Code_Morceau'] . "\"> <input type=\"hidden\" name=\"Code_Album\" value=\" ". $_GET['Code_Album'] . "\"><button type=\"submit\"> Acheter</button>
          </form> ". " </td>";
          }
          echo "</tr>";
          }
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="post" action="validationDisque.php">
            <div class="form-group">
